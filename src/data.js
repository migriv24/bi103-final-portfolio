export const SECTIONS = [
  {
    ...
    caption: 'Evidence, hypothesis, and cause-and-effect define how scientists understand neural function. This lab connects observable neural signals to biological theory, tracing how the brain processes information from neuron to perception.',
  },
  {
    id: 'science-skills',
  ...
  },
  {
    ...
    caption: 'Scientific knowledge shapes how society responds to disease. This lab examines how disease information travels through media and public health, building the literacy to evaluate scientific claims in the real world.',
  },
  {
    id: 'biology-concepts',
    ...
    caption: 'The immune system is one of biology\'s most complex, organized systems. This lab traces how B cells, T cells, and antibodies perform specific functions together, placing the adaptive immune response in an evolutionary context.',
  },
  {
    id: 'biology-skills',
    outcome: 'Biology Skills',
    group: 'biology',
    ...
    caption: 'Biology skills start with careful observation and inference. This lab analyzes skeletal and muscular structures to understand how their features produce movement, applying the same reasoning biologists use with any organism.',
  },
  {
    id: 'biology-connections',
    outcome: 'Biology Connections',
    group: 'biology',
    ...
    caption: 'Biology is most meaningful when personal. This game turns the digestive system into a daily experience the player can feel, connecting biological knowledge to lived life in a way that sticks beyond the classroom.',
  },
  {
    id: 'human-concepts',
  ...
  },
  {
    ...
    caption: 'Researching humans requires both technical skill and ethical care. This lab covers data collection methods, validation practices, and the principles of informed consent and privacy that govern responsible human biological research.',
  },
  {
    ...
    caption: 'Communicating about human biology means matching the message to the medium. This media piece translates biological datasets into visual formats, making human body data legible and personally relevant to a general audience.',
  },
];
